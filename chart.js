...
function chartJSSearchedSetting(i) {
    ...
    let defense = searchedPokemon[i]['stats']['2']['base_stat'];
    let special_attack = searchedPokemon[i]['stats']['3']['base_stat'];
    let special_defense = searchedPokemon[i]['stats']['4']['base_stat'];
    let speed = searchedPokemon[i]['stats']['5']['base_stat'];
